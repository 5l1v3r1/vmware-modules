MODULES = vmmon vmnet vsock vmci
KBUILD_EXTMOD = $(MODULES:%=%-only)
...
.PHONY: FORCE KBUILD_EXTMOD $(KBUILD_EXTMOD) clean tarballs

KBUILD_EXTMOD: retiredcheck $(KBUILD_EXTMOD)
